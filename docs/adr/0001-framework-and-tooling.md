...
Tests use NUnit 4.6.1, NUnit3TestAdapter 6.3.0 and Microsoft.NET.Test.Sdk 18.0.1. FluentAssertions was upgraded to 8.11.0 on 19 September 2026 with explicit maintainer approval. It is used only to test this open-source project under the Xceed Community licence, rather than Apache-2.0. All references are private test dependencies; neither published package references or redistributes it. The Renovate major-version restriction has been removed. See the [upstream licence](https://github.com/fluentassertions/fluentassertions/blob/9ed9dc02c47e6ad6bb0b00401fe8ab21b6fd60eb/LICENSE). Removing xUnit must not weaken exact exception, cancellation, single-flight, ownership or shutdown assertions. No compatibility shim is retained.
